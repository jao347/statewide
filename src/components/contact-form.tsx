...
import { getUTMs } from "@/lib/utm"; // ✅ import UTM helper
...
export default function ContactForm({
  ...
  // ✅ Sync UTM data from localStorage
  useEffect(() => {
    const data = getUTMs();
  ...
  return (
    <div className={className}>
      ...
      <textarea
        ...
        className="w-full border border-gray-300 rounded-md p-3 h-28 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500"
      />
