  ...
  return (
    <>
            ...
            <div className="px-2 pt-2 pb-6 space-y-1 bg-white/95 backdrop-blur-md rounded-b-2xl shadow-lg">
              {["home", "about", "services", "gallery", "contact"].map(item => (
                <a
                  ...
                  href={item === "home" ? "/" : `#${item}`}
                  onClick={e =>
                    handleSmoothScroll(e, item === "home" ? "html" : `#${item}`)
                  }
      ...
      <div className="fixed bottom-5 right-5 z-50 md:hidden">
        <Button
          onClick={callNow}
          className="bg-red-600 hover:bg-red-700 text-white shadow-lg rounded-full px-5 py-3 flex items-center gap-2 animate-bounce"
        >
