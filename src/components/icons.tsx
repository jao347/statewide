...
export function Flame({ className }: { className?: string }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 2c1.5 3.5 3 5.5 3 8.5 0 3-2 5.5-5 5.5s-5-2.5-5-5.5c0-3 1.5-5 3-8.5 0 3 1 4 2 4s2-1 2-4zm0 18c-3.866 0-7-3.134-7-7 0-1.5.5-3 1.5-4.5C7.5 10 9 11 10 12c.5.5 1 1 2 1s1.5-.5 2-1c1-1 2.5-2 3.5-3.5 1 1.5 1.5 3 1.5 4.5 0 3.866-3.134 7-7 7z" />
    </svg>
  )
}
